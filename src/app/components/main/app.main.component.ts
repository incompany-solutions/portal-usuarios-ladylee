...
export class AppMainComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  constructor(public renderer: Renderer2, private primengConfig: PrimeNGConfig, public app: AppComponent, private router: Router, private authService: AuthService) {}
